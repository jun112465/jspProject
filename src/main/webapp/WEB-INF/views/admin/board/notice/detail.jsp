    ...
    <div class="content-container clearfix">
        ...
        <aside class="aside">
            ...
            <nav class="menu text-menu first margin-top">
                <h1>마이페이지</h1>
                <ul>
                    <li><a href="/WEB-INF/views/admin/index.html">관리자홈</a></li>
        ...
        <main>
            ...
            <div class="margin-top text-align-center">
                ...
                <a class="btn-text btn-default" href="detail/edit?id=${n.id}">수정</a>
                <a class="btn-text btn-default" href="detail/del?id=${n.id}">삭제</a>
            </div>
