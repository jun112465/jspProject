        ...
        <main class="main">
            ...
            <form action="list" method="post" accept-charset="utf-8">
                <div class="notice margin-top">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><%=n.getViews()%></td>
                            <td><input type="checkbox" name="openId" value="${n.id}"></td>
                            <td><input type="checkbox" name="dltId" value="${n.id}"></td>
                        </tr>
                ...
                <div class="indexer margin-top align-right">
                    ...
                    <div><span class="text-orange text-strong">${requestScope.curPage}</span> / ${requestScope.totalPage} pages</div>
                </div>

                <div class="text-align-right margin-top">
                    <input type="submit" class="btn-text btn-default" value="open" name="sendBtn">
                    <input type="submit" class="btn-text btn-default" value="delete" name="sendBtn">
